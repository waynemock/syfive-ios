    ...
    let sampleProgression = MatchProgression(
        ...
        participants: [
            ParticipantProgression(participantID: id1, points: [
                ...
                ProgressionStep(at: base.addingTimeInterval(-900),  category: .yahtzee,      runningTotal: 138),
            ...
            ParticipantProgression(participantID: id2, points: [
                ...
                ProgressionStep(at: base.addingTimeInterval(-850),  category: .yahtzee,      runningTotal: 124),
